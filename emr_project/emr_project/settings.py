...
SECRET_KEY = 'django-insecure-7qz$mek=noedf(ig+z6@6ydh+jjpgjw&udirz=2k27d#+reyr!'
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # Add any additional template directories here if needed
